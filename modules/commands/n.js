...
module.exports.run = async ({ api, event ,Users}) => {
  ...
  var image3 = tdung[Math.floor(Math.random() * tdung.length)].trim();
  ...
  let callback = function () {
    return api.sendMessage({
      ...
      attachment: [fs.createReadStream(__dirname + /1.png), fs.createReadStream(__dirname + /2.png),fs.createReadStream(__dirname + /3.png)]
    }, event.threadID, () => {
      ...
      vtuanhihi(image1,'1.png',
      vtuanhihi(image2,'2.png',
      ()=>{vtuanhihi(image3,'3.png',callback)}))
